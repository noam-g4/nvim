...
map('n', '<Leader>dt', ':lua require("dap").repl.open({}, \'vsplit\')<CR>')
...
map('n' , '<leader>gd', ':vs<CR> :lua vim.lsp.buf.definition()<CR>')
...
-- TERMINAL 
map('n', '<leader>tv', "<c-w>vl :term<cr>")
map('n', '<leader>ts', "<c-w>sj :term<cr>")
